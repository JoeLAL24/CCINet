...
def main(args):
    ...
    try:
        modelname = os.path.join(args.param_root, 'model-199.pt')
        cci_net_dict = torch.load(modelname)
        print('loaded', modelname)
    except:
        cci_net_dict = torch.load(os.path.join(args.param_root, 'ccinet.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--size',
                        ...
                        type=int,
                        help='input size')
    parser.add_argument('--param_root', default='./data1/ccinet/temp', type=str, help='model folder')
    parser.add_argument('--save_root', default='./pred', type=str, help='Output folder')
